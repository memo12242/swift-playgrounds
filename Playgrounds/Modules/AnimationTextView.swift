...
//  Playgrounds
//
//  Created by Madoka Suzuki on 2025/12/28.
//

import SwiftUI

struct TextAnimationView: View {
    @State var viewType: Int = 1
    let text = """
        ...
        ZStack {
            ScrollView {
                Group {
                    switch viewType {
                    case 1:
                        TextAnimationView1(text: text)
                    case 2:
                        TextAnimationView2(text: text)
                    default:
                        EmptyView()
                    }
                }
            ...
            VStack {
                Picker("", selection: $viewType) {
                    Button("1") { viewType = 1 }.tag(1)
                    Button("2") { viewType = 2 }.tag(2)
                }
...
struct TextAnimationView1: View {
    let text: String
    let interval: TimeInterval = 0.0001
...
struct TextAnimationView2: View {
